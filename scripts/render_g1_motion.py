...
def render_motion(motion: dict, rt: G1MujocoRuntime, out_dir: str,
                  ...
                  height: int = G1MujocoRuntime.RENDER_H) -> dict:
...
def main() -> int:
    ...
    ap.add_argument("--width", type=int, default=G1MujocoRuntime.RENDER_W)
    ap.add_argument("--height", type=int, default=G1MujocoRuntime.RENDER_H)
    args = ap.parse_args()
